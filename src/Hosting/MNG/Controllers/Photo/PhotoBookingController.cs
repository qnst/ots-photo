...
namespace QN.Ots.Photo.MNG.Hosting.Controllers
{
    ...
    public class PhotoBookingController : PhotoMNGBaseController
    {
        ...
        [HttpPost()]
        [QNAllowAnonymous]
        [Route("photo/list-photo-booking-api")]
        public IActionResult GetPhotoBookingPagingApi([FromBody] PageRequest<PhotoBookingBiz> data)
        {
            var currentUserId = PhotoHelper.GetCurrentUser()?.Id ?? "/";
            data.Data = new PhotoBookingBiz() { UserId = currentUserId };
