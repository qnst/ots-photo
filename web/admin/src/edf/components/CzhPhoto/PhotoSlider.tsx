...
export default function PhotoSlider(props: IPhotoSliderProps) {
  ...
  return (
    ...
    >
      ...
      {bannerVisible && (
        <div className="PhotoView-Slider__BannerWrap">
          <div className="PhotoView-Slider__Counter">
            <span className='Slider_CrtIndex'>{index + 1}</span> / <span className='Slider_TotalIndex'>{imageLength}</span>
          </div>
      ...
      {/* 将关闭图标始终显示 */}
      <CloseIcon className="PhotoView-Slider__toolbarIcon" onClick={close}></CloseIcon>
